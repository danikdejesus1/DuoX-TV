...
T = {
 "es": dict(
  ...
  fq=[
   ...
   ("¿Necesito una cuenta?", "No para ver contenido público. Para ver tus seguidos, conecta Twitch o Kick por QR desde el móvil. En Kick, confirma el código de seis dígitos y los seguidos se cargan automáticamente. Si usabas el acceso web anterior, conecta Kick de nuevo una vez. La búsqueda de Twitch requiere conectar esa cuenta."),
 ...
 "en": dict(
  ...
  fq=[
   ...
   ("Do I need an account?", "Not to watch public content. Connect Twitch or Kick by QR on your phone to see your follows. For Kick, confirm the six-digit code and followed channels load automatically. If you used the old web sign-in, link Kick again once. Twitch channel search requires connecting that account."),
